...
#Player stats, in a list; turn order, player name, money, number of color IPs, number of RRs and utilities, total IPs, number of mortgaged IPs, ?  ,?   ,? ...

player1 = [1, 0, 1,500, 0, 0, 0, 0]
player2 = [2, 0, 1,500, 0, 0, 0, 0]
player3 = [3, 0, 1,500, 0, 0, 0, 0]
player4 = [4, 0, 1,500, 0, 0, 0, 0]
player5 = [5, 0, 1,500, 0, 0, 0, 0]
player6 = [6, 0, 1,500, 0, 0, 0, 0]
player7 = [7, 0, 1,500, 0, 0, 0, 0]
player8 = [8, 0, 1,500, 0, 0, 0, 0]

charactertuple = ("1. Lizzie-Maggie", "2. Mensch", "3. Peddle", "4. Woz", "5. Lilienfeld", "6. Cady", "7. Picard", "8. Hoerni")
charactertupleaslist1 = ["1. Lizzie-Maggie"]
charactertupleaslist2 = ["2. Mensch"]
charactertupleaslist3 = ["3. Peddle"]
charactertupleaslist4 = ["4. Woz"]
charactertupleaslist5 = ["5. Lilienfeld"]
charactertupleaslist6 = ["6. Cady"]
...
while Loop <= HowManyPlayers:
	...
	if 	Loop == 1:
		...
		if characterliststillavailable[characterchoice3] == 0:
			print("Error! This character has already been chosen. Please choose an available character.")
			Loop = 3
		else:
		...
		if characterliststillavailable[characterchoice4] == 0:
			print("Error! This character has already been chosen. Please choose an available character.")
			Loop = 4
		else:
		...
		if characterliststillavailable[characterchoice5] == 0:
			print("Error! This character has already been chosen. Please choose an available character.")
			Loop = 5
		else:
		...
		if characterliststillavailable[characterchoice6] == 0:
			print("Error! This character has already been chosen. Please choose an available character.")
			Loop = 6
		else:
		...
		if characterliststillavailable[characterchoice7] == 0:
			print("Error! This character has already been chosen. Please choose an available character.")
			Loop = 7
		else:
		...
		if characterliststillavailable[characterchoice8] == 0:
			print("Error! This character has already been chosen. Please choose an available character.")
			Loop = 8
		else:
...
#	elif Loop == 2:
#		print("Technopoly!", charactertupleaslist1[0], ", you are currently on GO).")
#		print((characterlistassigned[P-1], ',')
#		roll_em = input("Press Enter to roll dice; Press q + Enter to end")
