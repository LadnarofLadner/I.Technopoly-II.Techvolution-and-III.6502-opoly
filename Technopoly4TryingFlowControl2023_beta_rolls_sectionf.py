...
while Loop <= HowManyPlayers:
	...
	print (charactertuple)
	characterchoice = input ()
	characterchoice = int(characterchoice)
	characterchoice = (characterchoice - 1)
	if 	Loop == 1:
		characterchoice1  = (characterchoice + 0)
		print(charactertuple[characterchoice1])
		player1.insert(0, characterchoice1)
		characterlist.insert(characterchoice1,0)
		Loop = Loop + dLoop
	else: 
		if 	Loop == 2:
			characterchoice2  = (characterchoice + 0)
			characterchoice2 != characterchoice1
			print(charactertuple[characterchoice2])
			player2.insert(0, characterchoice2)
			characterlist.insert(characterchoice2,0)
			Loop = Loop + dLoop
		else: 
			if 	Loop == 3:
				characterchoice3  = (characterchoice + 0)
				characterchoice3 != characterchoice2 != characterchoice1
				print(charactertuple[characterchoice3])
				player3.insert(0, characterchoice3)
				characterlist.insert(characterchoice3,0)
				Loop = Loop + dLoop
			else: 
				if 	Loop == 4:
					characterchoice4  = (characterchoice + 0)
					print(charactertuple[characterchoice4])
					player4.insert(0, characterchoice4)
					characterlist.insert(characterchoice4,0)
					Loop = Loop + dLoop
				else: 
					if 	Loop == 5:
						characterchoice5  = (characterchoice + 0)
						print(charactertuple[characterchoice5])
						player5.insert(0, characterchoice5)
						characterlist.insert(characterchoice5,0)
						Loop = Loop + dLoop
					else: 					
						if 	Loop == 6:
							characterchoice6 = (characterchoice + 0)
							print(charactertuple[characterchoice6])
							player6.insert(0, characterchoice6)
							characterlist.insert(characterchoice6,0)
							Loop = Loop + dLoop
						else: 				
							if 	Loop == 7:
								characterchoice7  = (characterchoice + 0)
								print(charactertuple[characterchoice7])
								player7.insert(0, characterchoice7)
								characterlist.insert(characterchoice7,0)
								Loop = Loop + dLoop
							else: 
								if 	Loop == 8:
									characterchoice8  = (characterchoice + 0)
									print(charactertuple[characterchoice8])
									player8.insert(0, characterchoice8)
									characterlist.insert(characterchoice8,0)
									Loop = Loop + dLoop
								else: 
									Loop == 9
...
for P in PlayerTurnsSequence:
	if P <= HowManyPlayers:
		print("Technopoly!", characterlist[P], ", you are currently on GO).")
