...
#Player stats, in a list; 0th turn order, 1st player name, 2nd money, 3rd number of color IPs, 4th number of RRs and utilities, 5th total IPs, 6th number of mortgaged IPs, 7th Net Liquidated Worth, 8th current lap number, 9th current era, 10th leading or lagging #, 11th current space at end of turn, ?   ,? ...

player1 = [1, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player2 = [2, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player3 = [3, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player4 = [4, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player5 = [5, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player6 = [6, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player7 = [7, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
player8 = [8, 0, 1.5e3, 0, 0, 0, 0, 0, 0, 0, 0, 0]
...
while Loop <= HowManyPlayers:
	if 	Loop == 1:
		...
		if (roll_em != "q")  :
			...
			if spaces[current] == "Go (COLLECT 200$)" or "Patent Fees" or "Serendipity ; Community Quest" or "Innovation Station" or "Visiting College ; Research" or "Serendipity ; Community Quest" or "Parents Garage" or "Innovation Station" or "Go To College" or "Serendipity ; Community Quest" or "Innovation Station" or "Incorporation fees":
				print("Not for sale.")
			else:
		...
		if (roll_em != "q")  :
			...
			Purchase = input("Press 0 to purchase or 1 to pay rent")
			if (Purchase == "0"):
				print('IP development costs are "{0}" is .'.format(mySpace.upper()))
				print('"{0}"'.format(IPdevelopmentcosts[current]))
				print("acknowledgedebug0")
				print(Loop)
				if die1 == die2 and doubles == 0:
