...
characterlist = ["1. Lizzie-Maggie", "2. Mensch", "3. Peddle", "4. Woz", "5. Lilienfeld", "6. Cady", "7. Picard", "8. Hoerni"]
charactertuple = ("Lizzie-Maggie", "Mensch", "Peddle", "Woz", "Lilienfeld", "Cady", "Picard", "Hoerni")
...
PlayerTurnsSequence = [0, 1, 2, 3, 4, 5, 6, 7]
current = 0
die1 = die2 = total = 0
doubles = 0
rolls = 0
for P in PlayerTurnsSequence:
	if P <= HowManyPlayers:
		print("Technopoly!", charactertuple[P], ", you are currently on GO).")
